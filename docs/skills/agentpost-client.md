...
This file mirrors the client guide embedded in `GET /api/v1/skill`. **Edit** [`cmd/agentpost/skills/agentpost-client.md`](../../cmd/agentpost/skills/agentpost-client.md) (the `go:embed` source), then sync this file if you want docs to match.
